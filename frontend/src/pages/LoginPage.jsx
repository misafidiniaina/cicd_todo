  ...
  return (
    <div className="h-screen flex items-stretch bg-white font-['Inter',_sans-serif] antialiased">
      <div className="flex w-full">
        {/* Left Side - Todo App Branding */}
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-600 to-indigo-600 items-center justify-center relative overflow-hidden"></div>
            ...
            <form onSubmit={handleLogin} className="space-y-3.5">
              <div className="space-y-0.5">
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 font-grotesk text-sm bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent focus:bg-white transition-all duration-200 outline-none"
                />
              </div>
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex justify-between items-center pt-3">
                  <div className="flex items-center">
                    <label className="text-[#8b8b8b] font-grotesk text-sm ">
                      <input
                        type="checkbox"
                        checked={isChecked}
                        onChange={handleChange}
                        className="w-4 h-4 text-blue-600 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600"
                      />
                      Remember me
                    </label>
                  </div>
                  <a
                    href=""
                    className="text-indigo-600 hover:text-indigo-700 font-grotesk text-sm "
                  >
                    forget password?
                  </a>
                </div>
